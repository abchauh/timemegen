...
➜  Local:   http://localhost:5173/timemegen
➜  press h + enter to show help
```

To view the application, you need to open the `Local`
link (`http://localhost:5173/timemegen` in this example) in your browser:
...
➜  Local:   https://localhost:5173/timemegen
➜  press h + enter to show help
```

Visiting the `Local` link (`https://localhost:5173/timemegen` in this example) in your
...
➜  Local:   https://localhost:5173/timemegen
➜  Network: https://172.27.224.1:5173/timemegen
➜  Network: https://172.19.32.1:5173/timemegen
➜  Network: https://192.168.0.171:5173/timemegen
```
